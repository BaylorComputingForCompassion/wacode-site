...
const RegularMap = withScriptjs(
  withGoogleMap(() => (
    <GoogleMap
      defaultZoom={18}
      defaultCenter={{
        lat: 31.546290749999997,
        lng: -97.1182678514605 - 0.002
      }}
      defaultOptions={{
        scrollwheel: false,
        zoomControl: true,
    ...
    >
      <Marker position={{ lat: 31.546290749999997, lng: -97.1182678514605 }} />
    </GoogleMap>
  ))
);
    ...
    return (
      <div>
        <Header
          ...
          fixed
        />
        <div className={classes.contacts2} style={{ marginTop: "70px" }}>
          <div className={classes.map}>
            <RegularMap
              googleMapURL="https://maps.googleapis.com/maps/api/js?key=AIzaSyB-elLOVuda86FtsS7iGwBMjvjTQaSSbYk"
              loadingElement={<div style={{ height: `82%` }} />}
              containerElement={<div style={{ height: `100%` }} />}
              mapElement={<div style={{ height: `82%` }} />}
            />
          </div>
...
export default withStyles(contactsStyle)(ContactUsPage);

    ...
    <div className={`${classes.services} cd-section`} {...rest}>
      ...
      <GridContainer>
        ...
        >
          ...
          <h4 className={classes.title}>
            1st Place: $60 Amazon Gift Card (to each member of the winning team)
            + Swag!
          </h4>
          <h4 className={classes.title}>
            2nd Place: $40 Amazon Gift Card (to each member of the winning team)
            + Swag!
          </h4>
          <h4 className={classes.title}>
            3rd Place: $20 Amazon Gift Card (to each member of the winning team)
            + Swag!
          </h4>
        </GridItem>
      </GridContainer>
